...
public class StudentScore extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lvinfo.setOnItemClickListener(new OnItemClickListener(){// 为ListView添加项单击事件
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(StudentScore.this, ScoreInfo.class);// 创建Intent对象
	...
	private void ShowInfo() {// 用来根据传入的管理类型，显示相应的信息
		...
		ScoreDAO scoreDAO = new ScoreDAO(StudentScore.this);// 创建ScoreDAO对象
		// 获取所有学生信息，并存储到List泛型集合中
